	...
	return (
		<main className=" flex flex-col gap-5 p-5 max-xs:px-5 max-xs:py-2">
			<div className="flex flex-col">
				<h2 className="poppins font-semibold text-2xl">Links & Tools</h2>
			...
			<section className="flex w-full flex-col gap-10 p-4  bg-white custom-shadow rounded-lg max-sm:gap-0">
				<div className="flex items-center gap-3 justify-between max-xs:flex-col max-xs:items-start flex-wrap">
					<h2 className="poppins-bold text-2xl max-xs:text-xl">
						Your Referral Links
					</h2>
					<button
						className="h-[40px] bg-primary hover:bg-primary-dark text-base font-semibold text-white flex items-center gap-2 px-2 rounded-md duration-150 max-sm:text-sm max-sm:h-[35px]"
			...
			<section className="w-full h-90 max-lg:h-auto flex gap-5 max-lg:flex-col">
				<div className="w-[65%] flex flex-col gap-4 custom-shadow rounded-lg p-4 bg-white max-lg:w-full max-lg:h-100">
					<div className="w-full flex items-center justify-between flex-wrap gap-2">
						<h2 className="poppins-bold text-xl max-sm:text-base">
							Links Performance
						</h2>
				...
				<div className="flex flex-col gap-4 w-[35%] custom-shadow rounded-lg p-4 bg-white max-lg:w-full">
					...
					<p className="text-sm font-medium text-gray-500">
						Use our banners to promote WeFitHost
					</p>
